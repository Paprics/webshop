...
class Feedback(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="feedbacks", verbose_name='Користувач')
    ...
    status = models.CharField(max_length=30, choices=Status.choices, default=Status.UNREVIEWED, verbose_name='Статус')
