...
urlpatterns = [
    ...
    path(
        "customer_detail/", views.CustomerDetailView.as_view(), name="customer_detail"
    ),
    path(
        "create_category/", views.CreateCategoryView.as_view(), name="create_category"
    ),
    path(
        "create_products/", views.CreateProductsView.as_view(), name="create_products"
    ),
