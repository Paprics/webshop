...
urlpatterns = [
    ...
    path(
        "update_customer/", views.UpdateCustomerView.as_view(), name="update_customer"
    ),
    path(
        "update_delyvery/",
    ...
    path(
        "activate/failed/",
        TemplateView.as_view(template_name="activation_failed.html"),
        name="activation_failed",
    ),
    path(
        "activate/info/",
        TemplateView.as_view(template_name="activation_massage.html"),
        name="activation_massage",
    ),
