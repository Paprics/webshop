...
class ProductModel(models.Model):
    ...
    description = TextField(blank=True, validators=[MaxLengthValidator(1000)], verbose_name="Опис")
    image = models.ImageField(upload_to="image/", blank=True, verbose_name="Зображення")  # TODO -> M2O other model
    quantity = models.PositiveIntegerField(default=1, verbose_name="Кіл-ть")
    is_active = models.BooleanField(default=True, verbose_name="Активний")
    category = models.ForeignKey("CategoryModelMPTT", on_delete=models.PROTECT, verbose_name="Категорія")
